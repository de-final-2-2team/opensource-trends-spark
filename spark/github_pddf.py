...
class PD_df:
    ...
    def license_list(self):
        file_path = self.s3_client.get_file_name_from_s3('de-2-2', 'raw/github/meta/')
        license_json = self.s3_client.read_json_from_s3('de-2-2', file_path)
        return pd.DataFrame(license_json['license'])
